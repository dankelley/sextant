...
1. Print either the file named
   [sextant1.pdf](https://github.com/dankelley/sextant/raw/main/man/figures/sextant1.pdf)
   or the one named
   [sextant1.pdf](https://github.com/dankelley/sextant/raw/main/man/figures/sextant2.pdf)
...
building, etc) on a flat plane.  $L$ is a distance along the ground,
$\theta$ is the angle found by sighting to the top of the object, and
$H=L\tan\theta$ is the inferred height.](https://github.com/dankelley/sextant/raw/main/man/figures/fig1.png)
...
it's base, and then finding the angle $\theta$ to the top. (You may determine
$L$ by counting how many paces it takes you to cover 10 sidewalk blocks, and
then using a ruler to measure one block to get a conversion factor.) With $L$
and $\theta$ now known, you may calculate the object height with
...
be your height.  Note that $L$ may be measured in "pace" units, converted to
metres (or feet) using a calibration factor developed by pacing out a number of
sidewalk paving stones, then measuring the length of one of them with a ruler.
...
![Figure 2. Definition sketch for two-angle case.](https://github.com/dankelley/sextant/raw/main/man/figures/fig2.png)
...
where, again, $H_e$ is the height of your eye above the ground.
