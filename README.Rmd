...
angles and a ruler to measure $L_2$.  You should find $\theta=`r thetaDeg`$ and
$\phi=`r phiDeg`$.  The formula will tell you that the ratio of $H$ to $L_2$ is
`r H/L2`.  You ought to check this with a ruler.  As a further exercise, draw a
diagram like the one above, but with different angles, and see if the formula
gives the correct $H$, given your drawing.  Why not try a few test cases, to
build intuition and familiarity with the formula?
