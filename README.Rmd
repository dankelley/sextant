...
![Figure 1. Diagram for measuring tree height.  $L$ is a distance paced off on the ground, $\theta$
...
observation spots is $l$.  This is measured by pacing off distance along the
flat plain.  We measure $\Theta$, $\phi$, and $l$.

If we knew $L$, we could apply the method of Example 1 at both spots, giving
two estimates of height.  However, we cannot determine $L$ without without
...
yielding
\begin{equation}
L\tan\theta  = (l+L)\tan\phi
\end{equation}
which can be rearranged to
\begin{equation}
L(\tan\theta -\tan\phi) = l\tan\phi
\end{equation}
and then to
\begin{equation}
L = l\frac{\tan\phi}{\tan\theta-\tan\phi}
\end{equation}
at which point we have a formula for the unknown $L$.  This can be combined
with the original formula to give
\begin{equation}
H = l\frac{\tan\theta\tan\phi}{\tan\theta -\tan\phi}
\end{equation}


If we knew $L$ we could apply the earlier formula to both the near observation
and the far one.

We can apply the formula
from Example 1 if only we could unkonown
