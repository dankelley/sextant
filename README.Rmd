...
6. Attach fishing line, sewing thread, or thin string, at point "P", and attach
   something relatively heavy at the end.  The string should be long enough to
   extend to the edge of your instrument, so that the weight doesn't rub into
   it the device.  This line-weight combination forms what carpenters call a
   "plumb line," that is, something that always points vertically.
