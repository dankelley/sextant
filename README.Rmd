...
building, etc., on flat ground, by pacing off^[It's easy to convert a paced-off
distance to an actual distance by pacing off 10 paving stones in a sidewalk and
using a ruler to measure the length of one of the stones.] a horizontal
distance $L$ from it's base, and then finding the angle $\theta$ to the top.
The height above is then given by
\begin{equation}
H = H_e + L\tan\theta
\end{equation}
