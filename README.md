...
which you may take to be your height. Note that *L* may be measured in
“pace” units, converted to metres (or feet) using a calibration factor
developed by pacing out a number of sidewalk paving stones, then
