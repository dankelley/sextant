...
![Diagram for measuring tree height. *L* is a distance paced off on the
ground, *θ* is the angle found by sighting to the top of the tree, and
*H* = *L*tan *θ* is the inferred tree height.](tree.png)
